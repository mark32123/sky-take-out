...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public void save(EmployeeDTO employeeDTO) {
        ...
        BeanUtils.copyProperties(employeeDTO, employee);//拷贝属性 employeeDTO -> employee 两者属性名一致

        employee.setStatus(StatusConstant.ENABLE); //启用状态

        employee.setPassword(DigestUtils.md5DigestAsHex(PasswordConstant.DEFAULT_PASSWORD.getBytes())); //密码进行md5加密
