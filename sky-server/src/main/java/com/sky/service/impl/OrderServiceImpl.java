...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    @Transactional
    public OrderSubmitVO submitOder(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        orders.setNumber(String.valueOf(System.currentTimeMillis()));   //获取当前时间戳作为订单号
     ...
     */
    @Override
    public void cancelById(OrdersCancelDTO ordersCancelDTO) throws Exception {
        // 根据id查询订单
    ...
    public void complete(Long id) {
        ...
        orders.setDeliveryTime(LocalDateTime.now()); //送达时间为当前时间
        orderMapper.update(orders);
    }
